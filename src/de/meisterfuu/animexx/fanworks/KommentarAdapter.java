...
public class KommentarAdapter extends ArrayAdapter<KommentarObject> {

	private final Activity context;
	private ArrayList<KommentarObject> names;
	...
	public KommentarAdapter(Activity context, ArrayList<KommentarObject> names) {
		super(context, R.layout.home_kontakt_list_item, names);
		this.context = context;
		this.names = names;
	}


	public void refill(ArrayList<KommentarObject> names) {
		this.names = names;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final KommentarObject s = names.get(position);
