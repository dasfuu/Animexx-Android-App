...
public class RPGPostAdapter extends ArrayAdapter<RPGPostObject> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(s.isAction()) holder.text.setTypeface(null, Typeface.ITALIC); else holder.text.setTypeface(null, Typeface.NORMAL);
		holder.text.setText(Html.fromHtml(s.getPost()+"<br>"));
		
		if(!s.isIn_time()) holder.text.setTextColor(Color.GRAY); else holder.text.setTextColor(Color.BLACK);
