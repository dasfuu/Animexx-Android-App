...
public class ENSService extends Service {	
	...
	public class Task extends TimerTask{
		...
		public int GetUnread() {		
			...
			String jsonOutput = "";
	        try {
	        	jsonOutput = makeSecuredReq("https://ws.animexx.de/json/ens/anzahl_ungelesen/?api=2",getConsumer(config));
			...
			public int GetNewUnread(int sec) {		
				...
				String jsonOutput = "";
		        try {
		        	jsonOutput = makeSecuredReq("https://ws.animexx.de/json/ens/anzahl_neue_ens/?sekunden="+sec+"&api=2",getConsumer(config));
		...
		public String makeSecuredReq(String url,OAuthConsumer consumer) throws Exception {
