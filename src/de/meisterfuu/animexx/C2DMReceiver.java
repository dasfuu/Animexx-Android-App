...
public class C2DMReceiver extends BroadcastReceiver {
	...
	private void handleMessage(Context context, Intent intent) {		
	    ...
	    if(intent.getExtras().getString("type").equalsIgnoreCase("XXEventENS")){
	    	...
	    	notifyURL("Es ist etwas passiert, nur was? 42!", "Unbekanntes Event! 42!", context, 666, "http://animexx.de");	
	    }
	...
	private void handleRegistration(Context context, Intent intent) {
	    ...
	    if (intent.getStringExtra("error") != null) {
			...
			try {
				...
				Request.setC2DM();
				//Request.ENSNotify("Push Test!", "Deine erste gepushte ENS :D Scheint ja alles zu funktionieren!");				
			} catch (Exception e) {
...
/*
  "XXEventUsernameChange", "XXEventTwitterAnbindung", "XXEventSelbstbeschreibungAenderung", "XXEventSelbstbeschreibungErwaehnung", "XXEventEventsDabei",
			"XXEventGeburtstag", "XXEventMagDoujinshi", "XXEventMagWeblogeintrag", "XXEventMagEvent", "XXEventMagFanart", "XXEventMagBastelei", "XXEventMagFanfic", "XXEventMagFoto", "XXEventMagFotoreihe", "XXEventMagOekaki",
			"XXEventMagNews", "XXEventMagWettbewerb", "XXEventMagManga", "XXEventMagDVD", "XXEventMagArtbook", "XXEventMagCD",
			"XXEventMagGame", "XXEventMagAsia", "XXEventMagUmfrage", "XXEventMagCosplay", "XXEventMagJFashion", "XXEventMagForumThread", "XXEventMagForumPosting",
			"XXEventMagZirkelForumThread", "XXEventMagZirkelForumPosting", "XXEventMagEventVideo", "XXEventMagFanVideo", "XXEventMagWebshop", "XXEventMagAudiobook", "XXEventVerrealkontaktet", "XXEventSteckbriefVideoNeu"
*/
